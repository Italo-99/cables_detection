...
class DLO3DS(object):
    ...
    def __init__(self, iter_test = None):
        ...
        # DLO PROC PARAMS -> give the src/pkg.../scripts path
        ...
        # BLENDER CLASS: TAKES AN IMAGE FROM A CAMERA FRAME WHICH HAS THE SAME POSE OF THE ROBOT
        # The cable object is placed in blender environment, not in RViz
        ...
        self.camera_srv = None  # TODO:CameraBlender(self.main_fodler, self.obj_name, self.camera_matrix, self.distort_vec, self.camera_height, self.camera_width)
