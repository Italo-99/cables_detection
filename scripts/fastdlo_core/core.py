...
# CLASS IMPLEMENTATION OF A PIPELINE OF CABLE DETECTOR WITH FASTDLO
...
class Pipeline():
    ...
    # MAIN FUNCTION: takes the source image and the inference threshold, 
    #                and returns
    ...
    # Computer vision techniques to post-process the results of the neural network
    ...
    # Convert to list of points the nodes of the scheletonizer
    ...
    # Exclude scheleton paths which don't match a general pattern of cable path
